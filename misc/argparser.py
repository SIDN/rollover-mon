...
parser.add_argument("--details", help="Returns detailed monitoring state.", action="store_true")
...
# parser.add_argument("--plot", help="Creates a visualization of the measurement results.", action="store_true")
